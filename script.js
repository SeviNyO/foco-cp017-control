...
// Constante de Anuncio (ServS_UUIDicio que BUSCAMOS)
...
async function controlLuz(action) {
    ...
    try{
        document.getElementById('log').innerText = `Buscando CP017 automáticamente...`;

        // --- CAMBIO CLAVE (Volvemos al Filtro AF30) ---
